...
let s:module = {
\ 'name' : 'ccline-module-substitute',
\}

function! ccline#module#substitute#make() abort
  return deepcopy(s:module)
endfunction

function! s:module.init(cmdline) abort
  if &modifiable == 0
    return
  endif
  let s:undo_flag = 0
...
function! s:module.on_char(cmdline)
  call s:substitute_preview(a:cmdline.getline())
endfunction
