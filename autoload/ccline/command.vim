...
\ 'anoremenu': {'bar': 1},
\ 'append': {'bar': 1},
\ 'argadd': {'bar': 1, 'complete': 'file', 'count': '0'},
\ 'argdelete': {'bar': 1, 'complete': 'file', 'range': '0'},
\ 'argdo': {'bang': 1, 'bar': 0, 'complete': 'command'},
\ 'argedit': {'bang': 1, 'bar': 1, 'complete': 'file', 'count': '0'},
\ 'argglobal': {'bang': 1, 'bar': 1, 'complete': 'file'},
\ 'arglocal': {'bang': 1, 'bar': 1, 'complete': 'file'},
\ 'args': {'bar': 1, 'complete': 'file'},
\ 'argument': {'bang': 1, 'bar': 1, 'complete': '', 'count': '0'},
\ 'ascii': {'bar': 1, 'complete': ''},
\ 'augroup': {'bar': 1, 'complete': 'augroup'},
\ 'aunmenu': {'bar': 1},
\ 'autocmd': {'bar': 0, 'complete': 'event', 'nargs': '*'},
\ 'badd': {'bar': 1},
\ 'ball': {'bar': 1},
\ 'bdelete': {'bar': 1},
...
\ 'execute': {'bar': 1},
\ 'exusage': {'bar': 1},
\ 'file': {'bang': 1, 'bar': 1, 'nargs': '?', 'complete': 'file', 'count': '0'},
\ 'files': {'bar': 1},
\ 'filetype': {'bar': 1},
\ 'finally': {'bar': 1},
\ 'find': {'bang': 1, 'bar': 1},
...
\ 'for': {'bar': 1},
\ 'function': {'bar': 0, 'complete': 'function', 'nargs': '*'},
\ 'global': {'bar': 0},
\ 'goto': {'bar': 1},
\ 'grep': {'bar': 1},
\ 'grepadd': {'bar': 1},
...
\ 'if': {'bar': 1},
\ 'ijump': {'bar': 1},
\ 'ilist': {'bang': 0, 'bar': 1, 'range': '%', 'complete': 'buffer_word', 'nargs': '*'},
...
\ 'marks': {'bar': 1},
\ 'match': {'bar': 1},
\ 'menu': {'bar': 1, 'complete': 'menu', 'nargs': '*'},
\ 'menutranslate': {'bar': 1},
\ 'messages': {'bar': 1},
\ 'mkexrc': {'bar': 1},
\ 'mksession': {'bar': 1},
...
\ 'stopinsert': {'bar': 1},
\ 'stselect': {'bar': 1},
\ 'substitute': {'bang': 0, 'bar': 1, 'range': '.', 'complete': 'buffer_word', 'nargs': '*'},
\ 'sunhide': {'bar': 1},
